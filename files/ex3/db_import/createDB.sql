...
CREATE DATABASE webtech24products WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';

ALTER DATABASE webtech24products OWNER TO postgres;

\connect webtech24products
